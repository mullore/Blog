<template>
  <div class="flex-col justify-center align-item-center">
    <div>webgl</div>
    <canvas id="glCanvas" class="w-64 h-64" width="640" height="480" />
  </div>
</template>

<script lang="ts" setup>
import { onMounted } from 'vue';
import vsSource from '../shaders/index/vs.shaders?raw';
import fsSource from '../shaders/index/fs.shaders?raw';
// console.log("===");
